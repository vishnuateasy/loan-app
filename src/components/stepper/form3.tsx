...
const Form3: React.FC<Form3Props> = ({ onContinue, onBack }) => {
    const radioOptions = [
        { value: 'option-one', label: 'Below  ₹5 Lacs', color: 'text-blue-800' },
        { value: 'option-two', label: '₹5 - ₹10 Lacs', color: 'text-blue-800' },
        { value: 'option-three', label: '₹10 - ₹25 Lacs', color: 'text-blue-800' },
        { value: 'option-four', label: '₹25 - ₹50 Lacs', color: 'text-blue-800' },
        { value: 'option-five', label: '₹50 - ₹75 Lacs', color: 'text-blue-800' },
        { value: 'option-six', label: '₹75 Lacs - ₹1 Cr', color: 'text-blue-800' },
        { value: 'option-seven', label: 'Over ₹1 Cr', color: 'text-blue-800' },
      ];
  return (
        ...
        <RadioGroup defaultValue="option-one">
            <div className="flex flex-col space-y-2">
              {radioOptions.map((option) => (
                <div
                  key={option.value}
                  className="flex items-center justify-between w-4/6 space-x-2 border p-3 rounded-lg"
                >
                  <Label
