...
const Hform5: React.FC<Hform5Props> = ({ onContinue, onBack }) => {
    const radioOptions = [
        { value: "option-one", label: "HDFC", color: "text-blue" },
        { value: "option-two", label: "SBI", color: "text-blue" },
        { value: "option-three", label: "ICICI", color: "text-blue" },
        { value: "option-four", label: "Kotak", color: "text-blue" },
        { value: "option-five", label: "Axis", color: "text-blue" },
        { value: "option-six", label: "BOB", color: "text-blue" },
        { value: "option-seven", label: "PNB", color: "text-blue" },
        { value: "option-eight", label: "Yes Bank", color: "text-blue" },
      ];
      return (
